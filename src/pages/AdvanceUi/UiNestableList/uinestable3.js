        ...
        <Card>
          ...
          <CardBody>
            <p className="text-muted">
              ...
              class to set a nested list with sortable items where icons are
              given within list-group-item.
            </p>
            <ListGroup className="col nested-list nested-sortable">
              <ListGroupItem className="nested-1">
                {' '}
                <i className="mdi mdi-folder fs-16 align-middle text-warning me-2"></i>{' '}
                assets
                      ...
                      <React.Fragment key={key}>
                        {item.set1 ? (
                          ...
                          <ListGroupItem className={item.class}>
                            ...
                            <i
                              className={
                                'fs-16 align-middle text-warning me-2 ' +
                                item.icon
                              }
                            ></i>{' '}
                            {item.title}
